...
TP_QT_DEPRECATED typedef SharedPtr<StreamedMediaChannel> StreamedMediaChannelPtr;
TP_QT_DEPRECATED typedef SharedPtr<StreamedMediaStream> StreamedMediaStreamPtr;
